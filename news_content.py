...
自動追加の挨拶・予定を含めて約2100文字を狙う。各本文の目標文字数:
headlines=180,japan=180,okinawa=180,world=180,perspective_a=110,perspective_b=110,
stocks=150,fx=90,rates=110,gold=90,oil=90,products=110,services=110,ai=140,background=140。
eventsは重要な最大2件を優先し各本文は50文字程度。挨拶と予定日時は自動追加される。
